...
On the surface, giving a design a particular personality might sound abstract and handway, but a lot of it is determined by a few solid, concrete factors.
...
When you run into situations like this, instead of trying to further emphasize the element you want to draw attention to, figure out how you can deemphasize the elements that are competing with it.
...
**Too dark** border: 1px solid hsl(206, 16%, 74%);  
**Too light** border: 1px solid hsl(218, 23%, 95%);  

Making the border a bit heavier by increasing the width helps to emphasize it without losing the softer look.

Balanced border: 2px solid hsl(216, 23%, 95%);
...
Lowercase letters have a lot of variety visually. Letters like n, v, and e fit entirely within a typeface's x- height, other letters like y, g, and p have descendents that poke out below the baseline, and letters like b, f, and t have ascendents that extend above.
