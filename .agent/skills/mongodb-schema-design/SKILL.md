...
> **Project Context:** This is a general MongoDB reference skill. For Lindi's Store project-specific schema, see `.agent/lindis-store-context` (database architecture & collections) and `.agent/lindis-ecommerce-domain` (business logic patterns).
