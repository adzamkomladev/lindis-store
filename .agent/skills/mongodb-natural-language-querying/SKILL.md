...
> **Project Context:** This is a general MongoDB reference skill. For Lindi's Store project-specific patterns, see `.agent/lindis-store-context` (database architecture) and `.agent/lindis-api-endpoints` (API route patterns).
