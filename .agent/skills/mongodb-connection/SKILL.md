...
> **Project Context:** This is a general MongoDB reference skill. For Lindi's Store project-specific connection setup, see `server/db/mongodb.ts` and `.agent/lindis-store-context` (database architecture).
