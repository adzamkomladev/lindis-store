...
> **Project Context:** This is a general MongoDB MCP setup guide. For Lindi's Store project-specific database context, see `.agent/lindis-store-context` (database architecture & collections).
