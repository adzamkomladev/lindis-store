...
> **Project Context:** This is the general RivetKit reference documentation. For Lindi's Store project-specific actor patterns, see `.agent/lindis-rivet-actors` (actor architecture, patterns, and conventions used in this project).
