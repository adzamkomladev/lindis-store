...
> **Project Context:** This is the general RivetKit client reference. For Lindi's Store project-specific client usage, see `server/rivet/client.ts` and `.agent/lindis-rivet-actors` (actor interaction patterns).
