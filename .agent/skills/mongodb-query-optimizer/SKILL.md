...
> **Project Context:** This is a general MongoDB reference skill. For Lindi's Store project-specific queries and indexes, see `.agent/lindis-store-context` (index definitions) and `.agent/lindis-api-endpoints` (API route patterns).
