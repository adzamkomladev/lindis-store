        ...
        <div class="lg:col-span-2 space-y-5">
          ...
          <div class="bg-white border border-[#c5c6d1]/20">
            ...
            <div class="p-6 grid grid-cols-2 gap-4">
              <div v-for="spec in [
                { label:'Material', model:specMaterial, attrs:specMaterialAttrs, ph:'e.g. Stainless Steel' },
                { label:'Capacity', model:specCapacity, attrs:specCapacityAttrs, ph:'e.g. 500ml' },
                { label:'Dimensions', model:specDimensions, attrs:specDimensionsAttrs, ph:'e.g. 7cm x 25cm' },
                { label:'Weight', model:specWeight, attrs:specWeightAttrs, ph:'e.g. 200g' },
                { label:'Insulation', model:specInsulation, attrs:specInsulationAttrs, ph:'e.g. Double-wall vacuum' },
                { label:'Temp Retention', model:specTempRetention, attrs:specTempRetentionAttrs, ph:'e.g. 24h hot / 36h cold' },
              ]" :key="spec.label" class="space-y-1.5">
                <label class="text-xs font-body text-[#757681] block">{{ spec.label }}</label>
                <input v-model="spec.model.value" v-bind="spec.attrs" :placeholder="spec.ph"
