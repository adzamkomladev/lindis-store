    ...
    <div class="w-full max-w-sm">
      <div class="mb-10 text-center">
        ...
        <div v-if="submitted">
          ...
          <h2 class="font-headline font-bold text-on-surface text-on-surfacexl mb-2">Password Updated</h2>
          <p class="text-sm text-on-surface-variant font-body mb-6">Your password has been reset successfully.</p>
          <NuxtLink to="/login" class="inline-block px-8 py-3 bg-primary text-white font-label font-bold uppercase text-xs tracking-widest hover:opacity-90 transition-opacity">
            Sign In
          </NuxtLink>
        </div>
        <div v-else>
          <h2 class="font-headline font-bold text-on-surface text-on-surfacexl mb-2">New Password</h2>
