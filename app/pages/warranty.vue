...
<template>
  <div class="min-h-screen bg-background">
    <section class="pt-32 pb-16 px-8 max-w-screen-2xl mx-auto border-b border-outline-variant/20">
      ...
      <h1 class="font-headline font-medium italic text-5xl tracking-tight text-on-surface">Warranty</h1>
    </section>
    <div class="px-8 max-w-3xl mx-auto py-16 pb-24 space-y-12">
      ...
      <div>
        ...
        <ul class="list-disc list-inside text-on-surface-variant font-body space-y-2">
          ...
          <li>Storage containers: 6 months leak-proof guarantee</li>
          <li>Utensils & tools: 6 months against breakage under normal use</li>
        </ul>
      </div>
      <div>
