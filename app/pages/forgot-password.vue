    ...
    <div class="w-full max-w-sm">
      <div class="mb-10 text-center">
        ...
        <div v-if="submitted">
          ...
          <h2 class="font-headline font-bold text-on-surface text-on-surfacexl mb-2">Check your email</h2>
        ...
        <div v-else>
          <h2 class="font-headline font-bold text-on-surface text-on-surfacexl mb-2">Reset Password</h2>
