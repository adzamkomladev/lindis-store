...
<template>
  ...
  >
    ...
    >
      <div class="aspect-video w-full flex-1 rounded-lg border border-dashed flex flex-col items-center justify-center p-8 text-center bg-muted/50">
        <h3 class="text-lg font-medium text-foreground">No past performance records</h3>
        <p class="text-sm text-muted-foreground mt-1 mb-4 max-w-sm">You haven't added any past performance documents to this proposal yet.</p>
        <Button variant="outline"><IconPlus class="mr-2 h-4 w-4"/> Add Record</Button>
      </div>
    </TabsContent>
    <TabsContent value="key-personnel" class="flex flex-col px-4 lg:px-6">
      <div class="aspect-video w-full flex-1 rounded-lg border border-dashed flex flex-col items-center justify-center p-8 text-center bg-muted/50">
        <h3 class="text-lg font-medium text-foreground">No key personnel assigned</h3>
        <p class="text-sm text-muted-foreground mt-1 mb-4 max-w-sm">Assign team members to specific roles for this proposal to track coverage.</p>
        <Button variant="outline"><IconPlus class="mr-2 h-4 w-4"/> Assign Personnel</Button>
      </div>
    </TabsContent>
    <TabsContent
    ...
    >
      <div class="aspect-video w-full flex-1 rounded-lg border border-dashed flex flex-col items-center justify-center p-8 text-center bg-muted/50">
        <h3 class="text-lg font-medium text-foreground">No focus documents attached</h3>
        <p class="text-sm text-muted-foreground mt-1 mb-4 max-w-sm">Attach supplementary documents to highlight focus areas in this section.</p>
        <Button variant="outline"><IconPlus class="mr-2 h-4 w-4"/> Attach Document</Button>
      </div>
    </TabsContent>
  </Tabs>
</template>
